...
vim.schedule(function()
  if os.getenv('TMUX') then
    -- Use tmux buffer as clipboard (works over SSH)
    vim.g.clipboard = {
      name = 'tmux',
...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- R language server installed via R (install.packages("languageserver"))
      -- bypasses Mason due to Mason installer segfault on macOS
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'html', 'latex', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'r', 'vim', 'vimdoc' }
